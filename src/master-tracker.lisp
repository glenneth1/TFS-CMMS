             ...
             (cl-who:htm
              ...
              (:section :class "card"
                ...
                (:div :class "form-actions" :style "margin-bottom: 1rem; flex-wrap: wrap;"
                  ...
                  (:a :href (format nil "/reports/~A/02_Facilities_Inspected.png" report-dir)
                      :download "02_Facilities_Inspected.png" :class "btn" "Download Slide 2 (Facilities)")
                  (:a :href (format nil "/reports/~A/03_Top5_Hazards.png" report-dir)
                      :download "03_Top5_Hazards.png" :class "btn" "Download Slide 3 (Top 5 Hazards)")
                  (:a :href (format nil "/reports/~A/04_Inspection_Data_Weekly.png" report-dir)
                      :download "04_Inspection_Data_Weekly.png" :class "btn btn-primary" "Download Slide 4 (Weekly)")
                  (:a :href (format nil "/reports/~A/05_Inspection_Data_90Day.png" report-dir)
                      :download "05_Inspection_Data_90Day.png" :class "btn btn-primary" "Download Slide 5 (90-Day)")
                  (:a :href (format nil "/reports/~A/06_Inspection_Data_Cumulative.png" report-dir)
                      :download "06_Inspection_Data_Cumulative.png" :class "btn btn-primary" "Download Slide 6 (Cumulative)")
              ...
              (:section :class "card"
                (:h3 "Slide 2: Facilities Inspected (Weekly/90-Day/Cumulative)")
                (:img :src (format nil "/reports/~A/02_Facilities_Inspected.png" report-dir)
                      :style "max-width: 100%; border: 1px solid #ccc;"))
              (:section :class "card"
                (:h3 "Slide 3: Top 5 Hazards (Weekly/90-Day/Cumulative)")
                (:img :src (format nil "/reports/~A/03_Top5_Hazards.png" report-dir)
                      :style "max-width: 100%; border: 1px solid #ccc;"))
              (:section :class "card"
                (:h3 "Slide 4: Weekly Inspection Data (by Country/Site)")
                (:img :src (format nil "/reports/~A/04_Inspection_Data_Weekly.png" report-dir)
                      :style "max-width: 100%; border: 1px solid #ccc;"))
              (:section :class "card"
                (:h3 "Slide 5: 90-Day Inspection Data (by Country/Site)")
                (:img :src (format nil "/reports/~A/05_Inspection_Data_90Day.png" report-dir)
                      :style "max-width: 100%; border: 1px solid #ccc;"))
              (:section :class "card"
                (:h3 "Slide 6: Cumulative Inspection Data (by Country/Site)")
                (:img :src (format nil "/reports/~A/06_Inspection_Data_Cumulative.png" report-dir)
                      :style "max-width: 100%; border: 1px solid #ccc;"))
              (:section :class "card"
