                       ...
                       (dolist (item items)
                         (cl-who:htm
                          (:tr
                            ...
                            (:td (cl-who:fmt "~D" (truncate (or (getf item :|quantity_requested|) 0))))
                            (:td (cl-who:str (or (getf item :|uom|) "")))
                            (:td (cl-who:str (if (not (zerop (or (getf item :|is_material|) 0))) "Yes" "No")))
                            (:td (cl-who:str (if (not (zerop (or (getf item :|is_tool|) 0))) "Yes" "No")))
                   ...
                   (dolist (item items)
                     (cl-who:htm
                      (:tr
                        ...
                        (:td (cl-who:str (or (getf item :|description|) "")))
                        (:td :class "text-center" (cl-who:fmt "~D" (truncate (or (getf item :|quantity_requested|) 0))))
                        (:td (cl-who:str (or (getf item :|uom|) "")))
                        (:td :class "text-center" (cl-who:str (if (not (zerop (or (getf item :|is_material|) 0))) "X" "")))
                        (:td :class "text-center" (cl-who:str (if (not (zerop (or (getf item :|is_tool|) 0))) "X" "")))
                        (:td (cl-who:str (or (getf item :|remarks|) "")))
                        (:td (let ((link (getf item :|web_link|)))
                               (when (and link (not (string= link "")))
